namespace Atreus87Generator
{
    using System;
    using Atreus87Generator.Commands;
    using Atreus87Generator.Services;
    using Atreus87Generator.Services.Concrete;
    ...
    public static class Program
    {
        ...
        private static LoggingConfiguration GetNLogConfig()
        {
            var fileTarget = new FileTarget("logfile")
            {
                ...
                FileName = $"${{specialfolder:folder=CommonApplicationData}}/{nameof(Atreus87Generator)}/Logs/application.log",
                ArchiveFileName = $"${{specialfolder:folder=CommonApplicationData}}/{nameof(Atreus87Generator)}/Logs/application.#.log",
